...
const data = {
  ...
  about:
    "Enthusiastic Web Developer eager to contribute to team success through hard work, attention to detail.A clear understanding of ReactJs and NodeJs. Motivated to learn, grow and excel in learning new things.",
  ...
  experiance: [
    ...
    },
    {
      ...
      description: [
        "Worked on REST API simulator which is a platform that can be used to plug to any project with mock data. User is able to create multiple mocks services on the air and able to use them in their new or existing project and be able to doing CRUD operation with the help of Mock APIs.",
    ...
    },
    {
      ...
      description: [
        "Design and Develop a website for an AI based product from scratch that can extract textual information from any documents (pdf/scanned or image). And also added functionality where user can extract the text of selected portions on document.",
  ...
  service: [
    {
      ...
      description:
        "I have been working on web developemt for 3.5 years as MERN.",
      icon: <WebIcon />,
    },
    {
      title: "Blockchain",
  ...
  skill: [
    ...
    {
      title: "BECK-END",
      description: ["NodeJs", "Express", "Webpack", "MongoDB", "MySQL/SQL"],
    },
    {
      title: "OTHERS SKILLS",
      description: [
    ...
    {
      title: "BLOCKCHAIN",
      description: ["Solidity", "Ether/Web3", "NFT", "Hardhat/Truffle"],
    },
  ],
  projects: [
    {
    ...
    },
    {
      ...
      description:
        "Fill your heart with love, joy, and peace. Merry Christmas!",
      links: [
        {
          link: "https://asif56.github.io/christmasDay",
          icon: <LanguageIcon />,
        },
        {
          link: "https://github.com/Asif56/christmasDay",
          icon: <GitHubIcon />,
        },
      ],
    },
    ...
    },
    {
      ...
      caption:
        "A simple mordern to-do list Dapp with features like due dates and tasks'proiority.",
      description:
        "A simple mordern to-do list Dapp with features like due dates and tasks'proiority.",
      links: [
        {
          link: "https://fantastic-frangollo-2a1c7c.netlify.app/",
          icon: <LanguageIcon />,
        },
